...
const en = {
  ...
  tutorialJumpWhy: 'Tap, push the stick up, or press space. Height is the other way past things.',
...
const es: Record<StringKey, string> = {
  ...
  tutorialJumpWhy: 'Toca, empuja el mando hacia arriba o pulsa espacio. La altura es la otra forma de pasar.',
